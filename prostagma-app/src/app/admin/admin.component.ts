...
export class AdminComponent implements OnInit {
  ...
  public games$: Observable<Games[]> = new Observable<Games[]>();
  public categories$: Observable<Categories[]> = new Observable<Categories[]>();
  ...
  groupValue(content: any, arrayValue: any) {
    return ({categoryName: content, total: arrayValue.length});
  }

  groupByFn = (item: any) => item[this.cat];
